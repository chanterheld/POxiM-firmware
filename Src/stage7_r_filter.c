...
DEC_FIR_FILTER_ADVANCE(FILTER_NAME, filter_input_type, filter_output_type){
	...
	if(output_cycle == 1){
		...
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 12);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 14);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 16);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 18);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 20);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 22);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 24);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 26);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 28);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 30);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 32);
		FILTER_LINE_MEM_SAVE_MOVE(FILTER_NAME, 34);

		/*this line might have to go to the other block depending on filter size(even/uneven), the */
		FILTER_LAST_LINE_MEM_SAVE_EVEN(FILTER_NAME, 36);
		...
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 13);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 15);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 17);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 19);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 21);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 23);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 25);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 27);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 29);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 31);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 33);
		FILTER_LINE_MEM_SAVE_STATIONARY(FILTER_NAME, 35);
